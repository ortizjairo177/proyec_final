...
<head>
    ...
    <title>{{ config('app.name', 'Computer_prod') }}</title>
    <!--estilo de iconos -->
...
<a href="#"><img  src="{{ asset('images/logo.jpg') }}" width="100px" alt="logo1"></a>
  <a class="navbar-brand p-3 mb-2 bg-success text-white" href="#">COMPUTER SAS </a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="collapse navbar-collapse p-3 mb-2 bg-info text-white font-weight-bold" id="navbarNav">
  <ul class="navbar-nav mr-auto mr-auto mt-2 mt-lg-0 navib text-white" >
            ...
            @guest
                <!-- <li class="nav-item">
                    <a class="nav-link" href="{{ route('misproductos') }}">Mis Productos</a>
                </li> -->

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('listadoproductos') }}">Listado de Productos</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="/contact/create">Contactenos</a>
                </li>
...
<footer>
            ...
            <i class="bi bi-facebook">
                ...
                2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
            </svg>
